...
def load(drop_correlated = True, corr_thr = 0.85, hand="both"):
    ...
    print('# of Rows before dropping:', len(df))
    ...
    print('# of Rows After dropping:', len(df))
    '''
...
@click.option("--dropout_prob", default=0.2957076772877638)
...
@click.option("--learning_rate", default=0.7636384870941655, help="Learning rate for classifier")
...
@click.option("--momentum", default=0.3031685189746708)
@click.option("--use_scheduler", default='no', help="Options: yes, no")
@click.option("--scheduler", default='reduce', help="Options: step, reduce")
@click.option("--step_size", default=19)
@click.option("--gamma", default=0.6681853698209472)
