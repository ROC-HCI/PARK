...
@click.option("--dropout_prob", default=0.2043870326562422)
...
@click.option("--learning_rate", default=0.7201334167891106, help="Learning rate for classifier")
...
@click.option("--num_epochs", default=63)
...
@click.option("--momentum", default=0.4683258862616091)
...
@click.option("--gamma", default=0.7628045420088001)
