...
FINGER_FEATURES_FILE = os.path.join(BASE_DIR,"data/finger_tapping/data_finger_tapping.csv")
AUDIO_FEATURES_FILE = os.path.join(BASE_DIR,"data/quick_brown_fox/data_speech.csv")
FACIAL_FEATURES_FILE = os.path.join(BASE_DIR, "data/facial_expression_smile/data_smile.csv")
